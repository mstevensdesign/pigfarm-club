...
export const WoWLogo = (props: any) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={2497}
    height={2500}
  ...
  >
    <g transform="translate(29.75 53.5)">
      ...
      >
        <stop offset={0} stopColor="#5b779e" />
        <stop offset={0.399} stopColor="#2d3b50" />
      ...
      >
        ...
        <stop offset={1} stopOpacity={0.621} />
      </linearGradient>
      <path
        fill="url(#c)"
      ...
      <radialGradient
        ...
        cy={505.224}
        r={7.501}
        gradientTransform="matrix(3.7445 -.7613 -.396 -1.9477 9848.486 -1026.17)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#e6f1fd" />
        <stop offset={0} stopColor="#bdd9f9" />
        <stop offset={0.065} stopColor="#bdd9f9" />
        <stop offset={1} stopColor="#1c3556" stopOpacity={0.101} />
      </radialGradient>
      <path
        id="b"
        fill="url(#d)"
        d="m-3.25-49-.25 2.278c-.07.648-.343.49-.823.646l-4.116-.015c-1.214.39-1.347 1.036-1.265 1.588 2.306 1.282 3.746 4.921 3.955 6.002.296 1.042-.845 6.927-1.25 7.25-.683.425-4.73-.17-5.75-1-.548-.615-1.837-6.167-3-9.25-.428-1.103-1.576-1.878-2.5-2.5l7-4.5L-3.25-49z"
      />
      <linearGradient
        id="f"
        x1={-2286.269}
      ...
      <radialGradient
        ...
        cy={509.849}
        r={7.5}
        gradientTransform="matrix(3.7445 -.7613 -.396 -1.9477 9841.205 -1010.417)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#e6f1fd" />
        <stop offset={0} stopColor="#bdd9f9" />
    ...
    <path
      fillOpacity={0.318}
      d="m44.333 12.926-.031-6.938a1.235 1.235 0 0 0-1.25-1.25l-6.344-.062a1.24 1.24 0 0 0-.906 2.094l6.375 7c.345.381.89.509 1.37.322a1.24 1.24 0 0 0 .786-1.166z"
    />
    <path
      fillOpacity={0.318}
      d="m43.916 12.927-.031-6.938a.823.823 0 0 0-.812-.812l-6.344-.062a.828.828 0 0 0-.625 1.375l6.375 7a.827.827 0 0 0 1.437-.563z"
    />
    <path
      fillOpacity={0.318}
      d="m43.646 12.926-.031-6.938a.557.557 0 0 0-.161-.401.56.56 0 0 0-.401-.162l-6.344-.062a.555.555 0 0 0-.407.937l6.375 7a.554.554 0 0 0 .969-.374z"
    />
    <path
      fillOpacity={0.333}
      d="m43.34 12.931-.031-6.938a.26.26 0 0 0-.031-.094.27.27 0 0 0-.062-.094.302.302 0 0 0-.031-.031.255.255 0 0 0-.125-.031.302.302 0 0 0-.031-.031l-6.344-.062a.257.257 0 0 0-.062.031.267.267 0 0 0-.094.031.28.28 0 0 0-.062.062.281.281 0 0 0-.031.094.26.26 0 0 0 0 .156.28.28 0 0 0 .062.094l6.375 7a.27.27 0 0 0 .219.062.266.266 0 0 0 .125-.031c.012-.01.021-.02.031-.031a.257.257 0 0 0 .062-.094.282.282 0 0 0 .03-.093z"
    />
    <linearGradient
      id="i"
      x1={-2191.356}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#fdec97" />
      <stop offset={0.353} stopColor="#fdec97" />
      <stop offset={0.513} stopColor="#fdec97" />
      <stop offset={0.628} stopColor="#db990f" />
      <stop offset={1} stopColor="#db990f" />
    </linearGradient>
    <path fill="url(#i)" d="m37.086 6.036 5.928-.026-.057 6.369-5.871-6.343z" />
    <path
      fillOpacity={0.318}
      d="m37.125 42.375 6.938-.031a1.236 1.236 0 0 0 1.25-1.25l.062-6.344a1.238 1.238 0 0 0-2.094-.906l-7 6.375a1.238 1.238 0 0 0 .844 2.156z"
    />
    <path
      fillOpacity={0.318}
      d="m37.146 41.959 6.938-.031a.824.824 0 0 0 .812-.812l.062-6.344a.827.827 0 0 0-1.375-.625l-7 6.375a.826.826 0 0 0 .563 1.437z"
    />
    <path
      fillOpacity={0.318}
      d="m37.125 41.688 6.938-.031a.557.557 0 0 0 .562-.562l.062-6.344a.551.551 0 0 0-.937-.407l-7 6.375a.554.554 0 1 0 .375.969z"
    />
    <path
      fillOpacity={0.333}
      d="m37.097 41.387 6.938-.031a.267.267 0 0 0 .094-.031.27.27 0 0 0 .094-.062.302.302 0 0 0 .031-.031.257.257 0 0 0 .031-.125.302.302 0 0 0 .031-.031l.062-6.344a.3.3 0 0 0-.031-.062.289.289 0 0 0-.031-.094.28.28 0 0 0-.062-.062.281.281 0 0 0-.094-.031.26.26 0 0 0-.156 0 .27.27 0 0 0-.094.062l-7 6.375a.27.27 0 0 0-.062.219c0 .044.011.087.031.125.009.012.021.021.031.031a.25.25 0 0 0 .094.062.26.26 0 0 0 .093.03z"
    />
    <linearGradient
      id="j"
      x1={-2190.886}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#ffdc76" />
      <stop offset={0.327} stopColor="#e4903b" />
      <stop offset={0.451} stopColor="#ca4400" />
      <stop offset={0.58} stopColor="#fdec97" />
      <stop offset={0.704} stopColor="#db990f" />
      <stop offset={1} stopColor="#db990f" />
    </linearGradient>
    <path fill="url(#j)" d="m43.996 33.924.021 7.094H37.21l6.786-7.094z" />
    <path
      fillOpacity={0.318}
      d="m2.625 34.125.031 6.938a1.238 1.238 0 0 0 1.25 1.25l6.344.062c.498.005.949-.289 1.147-.746a1.24 1.24 0 0 0-.241-1.348l-6.375-7a1.24 1.24 0 0 0-2.156.844z"
    />
    <path
      fillOpacity={0.318}
      d="m3.062 34.146.031 6.938a.824.824 0 0 0 .813.812l6.344.062a.824.824 0 0 0 .625-1.375l-6.375-7a.828.828 0 0 0-.913-.215.828.828 0 0 0-.525.778z"
    />
    <path
      fillOpacity={0.318}
      d="m3.313 34.125.031 6.938a.549.549 0 0 0 .162.4c.106.107.25.165.401.162l6.344.062a.551.551 0 0 0 .406-.937l-6.375-7a.554.554 0 0 0-.969.375z"
    />
    <path
      fillOpacity={0.333}
      d="m3.589 34.102.031 6.938a.267.267 0 0 0 .031.094.28.28 0 0 0 .062.094c.009.012.02.021.031.031a.257.257 0 0 0 .125.031c.009.012.02.021.031.031l6.344.062a.277.277 0 0 0 .062-.031.289.289 0 0 0 .094-.031.28.28 0 0 0 .062-.062.281.281 0 0 0 .031-.094.26.26 0 0 0 0-.156.29.29 0 0 0-.062-.094l-6.375-7a.265.265 0 0 0-.219-.062.269.269 0 0 0-.125.031.227.227 0 0 0-.031.031.266.266 0 0 0-.062.094.26.26 0 0 0-.03.093z"
    />
    <linearGradient
      id="k"
      x1={-2221.405}
    ...
    <path
      fillOpacity={0.318}
      d="M11.938 4.75 5 4.781a1.238 1.238 0 0 0-1.25 1.25l-.062 6.344a1.238 1.238 0 0 0 2.094.906l7-6.375a1.237 1.237 0 0 0-.844-2.156z"
    />
    <path
      fillOpacity={0.318}
      d="M11.938 5.188 5 5.219a.824.824 0 0 0-.812.812l-.062 6.344A.827.827 0 0 0 5.5 13l7-6.375a.826.826 0 0 0-.562-1.437z"
    />
    <path
      fillOpacity={0.318}
      d="M11.938 5.438 5 5.469a.553.553 0 0 0-.562.562l-.062 6.344a.553.553 0 0 0 .937.406l7-6.375a.554.554 0 0 0-.375-.968z"
    />
    <path
      fillOpacity={0.333}
      d="M11.938 5.719 5 5.75a.26.26 0 0 0-.094.031.268.268 0 0 0-.094.063.227.227 0 0 0-.031.031A.275.275 0 0 0 4.75 6a.227.227 0 0 0-.031.031l-.062 6.344a.24.24 0 0 0 .031.062.26.26 0 0 0 .031.094.28.28 0 0 0 .062.062.26.26 0 0 0 .094.031.26.26 0 0 0 .156 0 .27.27 0 0 0 .094-.062l7-6.375a.264.264 0 0 0 .062-.219.275.275 0 0 0-.031-.125.227.227 0 0 0-.031-.031.261.261 0 0 0-.094-.062.262.262 0 0 0-.093-.031z"
    />
    <linearGradient
      id="l"
      x1={-2225.741}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#ca4400" />
      <stop offset={0.353} stopColor="#ca4400" />
      <stop offset={0.513} stopColor="#fdec97" />
      <stop offset={0.628} stopColor="#db990f" />
      <stop offset={1} stopColor="#db990f" />
    </linearGradient>
    <path
      id="h"
      fill="url(#l)"
      d="m4.95 12.379.037-6.333 6.946-.031-6.983 6.364z"
    />
    <g fillOpacity={0.288}>
    ...
    <linearGradient
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#da940f" />
      <stop offset={0.235} stopColor="#efd11a" />
      <stop offset={0.75} stopColor="#efd11a" />
      <stop offset={0.908} stopColor="#efd11a" />
      <stop offset={1} stopColor="#d3900e" />
    </linearGradient>
    <path
      fill="url(#n)"
      d="m11 11 3.379 2.496 4.523 21.035-2.906 2.477.473-2.414-4.75-21.188L11 11z"
    />
    <path
      fill="#792100"
      d="m18.906 34.531-2.91 2.477L22.922 37l-2.672-2.453-1.344-.016z"
    />
    <linearGradient
      id="o"
      x1={-2213.959}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#c63000" />
      <stop offset={0.491} stopColor="#db9000" />
      <stop offset={0.8} stopColor="#db9000" />
      <stop offset={1} stopColor="#c43b00" />
    </linearGradient>
    <path
      fill="url(#o)"
      d="m16.984 11.023-2.602 2.48 4.523 21.027 1.332.012L19.969 28 16.75 13.406l.234-2.383z"
    />
    <linearGradient
      id="p"
      x1={-2204.471}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#ad2f00" />
      <stop offset={1} stopColor="#cb7500" />
    </linearGradient>
    <path
      fill="url(#p)"
      d="m22.918 37.008-2.664-2.457 3.738-14.363.016 8.539-1.57 5.961.48 2.32z"
    />
    <linearGradient
      id="q"
      x1={-2204.523}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#ecd500" />
      <stop offset={0.869} stopColor="#ecd500" />
      <stop offset={1} stopColor="#ffef57" />
    </linearGradient>
    <path
      fill="url(#q)"
      d="M23.875 12.531 24 20.125l-3.754 14.434L20 28.062l3.875-15.531z"
    />
    <linearGradient
      id="r"
      x1={-2215.457}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#ffd511" />
      <stop offset={1} stopColor="#fdf8dc" />
    </linearGradient>
    <path fill="url(#r)" d="m10.992 11 3.391 2.5L17 11.008 10.992 11z" />
    <linearGradient
      id="s"
      x1={-2206.382}
      x2={-2200.552}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#bd3300" />
      <stop offset={0.188} stopColor="#bd3300" />
      <stop offset={0.411} stopColor="#cb8500" />
      <stop offset={1} stopColor="#c26f00" />
    </linearGradient>
    <path
      fill="url(#s)"
      d="m23.867 12.547.125 7.633 3.441 14.381 2.146.011-5.712-22.025z"
    />
    <linearGradient
      id="t"
      x1={-2206.619}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#ffd303" />
      <stop offset={0.902} stopColor="#ffd303" />
      <stop offset={1} stopColor="#d27e00" />
    </linearGradient>
    <path
      fill="url(#t)"
      d="m23.992 20.188.016 8.523 1.896 6.051-.672 2.236 2.221-2.428-3.461-14.382z"
    />
    <path
      fill="#792100"
      d="m29.57 34.559-2.109.008-2.244 2.441 7.793.014-3.44-2.463z"
    />
    <linearGradient
      id="u"
      x1={-2193.924}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#a51f00" />
      <stop offset={0.288} stopColor="#c67200" />
      <stop offset={0.644} stopColor="#c67200" />
      <stop offset={1} stopColor="#c25500" />
    </linearGradient>
    <path
      fill="url(#u)"
      d="m35.631 13.916 1.393-2.899-3.752 2.122-3.717 21.426 3.463 2.464-.959-2.546 3.572-20.567z"
    />
    <linearGradient
      id="v"
      x1={-2197.301}
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#cd7c00" />
      <stop offset={0.314} stopColor="#eed700" />
      <stop offset={1} stopColor="#eed700" />
    </linearGradient>
    <path
      fill="url(#v)"
      d="m30.643 13.375-.404-2.352 3.037 2.102-3.721 21.418-1.561-6.078 2.649-15.09z"
    />
    <linearGradient
      id="w"
      x1={-2195.818}
    ...
    <path
      fill="url(#w)"
      d="m30.235 11.016 3.022 2.132 3.783-2.145-6.805.013z"
    />
    <path
      fillOpacity={0.263}
    ...
    <linearGradient
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#51290e" />
      <stop offset={0.346} stopColor="#d08e29" />
      <stop offset={0.417} stopColor="#e1d02d" />
      <stop offset={0.498} stopColor="#f6e57f" />
      <stop offset={0.537} stopColor="#f6e57f" />
      <stop offset={0.605} stopColor="#e1d02d" />
      <stop offset={0.687} stopColor="#d08e29" />
      <stop offset={1} stopColor="#452a15" />
    </linearGradient>
    <path
      id="x"
      fill="url(#y)"
    ...
    <linearGradient
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0} stopColor="#ffe12b" />
      <stop offset={0.136} stopColor="#fff7c7" stopOpacity={0} />
      <stop offset={0.819} stopColor="#fff7c7" stopOpacity={0} />
      <stop offset={1} stopColor="#ffe12b" />
    </linearGradient>
    <path
      fill="url(#z)"
