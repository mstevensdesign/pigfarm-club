...
//             </div>
//             <div className="">{`${props.user?.pronouns}, ${props.user?.dob}`}</div>
//           </div>
//           <div className="">
...
//         {/* <Description /> */}
//       </div>
//       <div className="flex justify-center gap-20 pb-2 pt-10 text-black">
//         <svg
  ...
  return (
    <div className="flex flex-col items-center lg:flex-row">
      <img
        ...
        alt="avatar"
      />
      <div className="flex flex-col items-center bg-pink-300 lg:items-start">
        <div className={`${londrina.className} text-h6 text-green`}>
          {props.user?.display_name}
        </div>
